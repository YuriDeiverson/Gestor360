        ...
        <div className="flex items-center h-14 sm:h-16 justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl sm:rounded-2xl bg-gradient-to-tr flex items-center justify-center text-white text-xl font-semibold shadow-md">
                <svg
          ...
          <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3">
            ...
            <div className="relative">
              <button
                ...
                className="relative text-gray-600 hover:text-gray-900 hover:bg-gray-100 p-2 rounded-lg transition-colors touch-manipulation active:scale-95"
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[10px] sm:text-xs rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center font-bold animate-pulse">
                    {unreadCount > 9 ? "9+" : unreadCount}
                  </span>
                )}
              </button>

              {/* Dropdown Notificações - Mobile Responsive */}
              {showNotifications && (
                <div
                  ref={notificationDropdownRef}
                  className="absolute right-0 top-12 w-80 sm:w-96 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden max-h-[85vh] z-[100]"
                  style={{
                ...
                >
                  {/* Header responsivo */}
                  <div className="px-3 sm:px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
            ...
            <div className="relative">
              ...
              {showProfileMenu && (
                <div
                  ...
                  className="absolute right-0 top-12 w-64 sm:w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden z-[100]"
                ...
                >
                  ...
                  <div className="py-2">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 text-left hover:bg-blue-50 transition-colors group touch-manipulation active:bg-blue-100"
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <p className="font-semibold text-blue-600 group-hover:text-blue-700 transition-colors">
                            Gerenciar Dashboards
                          </p>
                          <p className="text-xs text-blue-500">
                            Criar, editar e alternar
                          </p>
                        </div>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 text-left hover:bg-red-50 transition-colors group touch-manipulation active:bg-red-100"
                    >
                      <div className="flex items-center space-x-3">
